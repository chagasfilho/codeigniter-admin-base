	...
	$(document).ready(function()
	{
		...
		if($.isFunction($.fn.datepicker))
		{
			$(".datepicker").each(function(i, el)
			{
				var $this = $(el),
					opts = {
						/* format: attrDefault($this, 'format', 'mm/dd/yyyy'), # ENG_US*/
						format: attrDefault($this, 'format', 'dd/mm/yyyy'), /*  # PT_BR*/
		...
		if($.isFunction($.fn.inputmask))
		{
			$("[data-mask]").each(function(i, el)
			{
				...
				{
					case "phone":
						mask = "(99) 9999-9999"; /* # PT_BR */
						break;
						
					case "currency":
					case "rcurrency":
					
						var sign = attrDefault($this, 'sign', 'R$');; /* # PT_BR */
						
						mask = "999.999.999,99"; /* # PT_BR */
