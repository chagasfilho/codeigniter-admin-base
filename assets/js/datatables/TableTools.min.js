...
TableTools.BUTTONS = {
	...
	"copy": $.extend( {}, TableTools.buttonBase, {
		...
		"sButtonText": "Copiar", // #PT_BR
		//"sButtonText": "Copy", #ENG_US
		"fnClick": function( nButton, oConfig, flash ) {
			this.fnSetText( flash, this.fnGetTableData(oConfig) );
		},
		"fnComplete": function(nButton, oConfig, flash, text) {
			var
				...
				plural = (len==1) ? "" : "s";
			this.fnInfo( '<h6>Tabela Copiada</h6>'+ // #PT_BR
			//this.fnInfo( '<h6>Table copied</h6>'+ #ENG_US
				'<p>Copiada '+len+' linha'+plural+' para o clipboard.</p>', // #PT_BR
				//'<p>Copied '+len+' row'+plural+' to the clipboard.</p>', #ENG_US
				1500
			);
		}
	} ),
	...
	"print": $.extend( {}, TableTools.buttonBase, {
		"sInfo": "<h6>Visualização da impressão</h6><p>Por favor use a função do seu navegador para "+
		  "imprimir essa tabela. Pressione esc quando finalizar.", // #PT_BR
		//"sInfo": "<h6>Print view</h6><p>Please use your browser's print function to "+
		//  "print this table. Press escape when finished.", #ENG_US
		"sMessage": null,
		"bShowAll": true,
		"sToolTip": "Visualização da impressão", // # PT_BR
		//"sToolTip": "View print view", // # ENG_US
		"sButtonClass": "DTTT_button_print",
		"sButtonText": "Imprimir", // #PT_BR
		//"sButtonText": "Imprimir", #ENG_US
